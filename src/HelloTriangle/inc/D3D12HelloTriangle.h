...
private:
    ...
    // D3D11_RESOURCE_MISC_SHARED_NTHANDLE does not support depth buffer formats
    // We will create a non-shared depth buffer and copy its contents into a shared texture
